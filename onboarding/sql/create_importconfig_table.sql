...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM dba."timportconfig" WHERE config_name = 'MeetMaxURLCheckImport') THEN
        CALL dba.pimportconfigi(
            ...
            'MeetMax',
            'MeetMaxURL',
            '/home/' || current_user || '/client_etl_workflow/file_watcher',
            '/home/' || current_user || '/client_etl_workflow/archive/import_MeetMaxURLCheckImport',
    ...
    IF NOT EXISTS (SELECT 1 FROM dba."timportconfig" WHERE config_name = 'MeetMax_Events_XLS_Import') THEN
        CALL dba.pimportconfigi(
            ...
            'MeetMaxEvents',
            '/home/' || current_user || '/client_etl_workflow/file_watcher',
            '/home/' || current_user || '/client_etl_workflow/archive/meetmaxevents',
